...
/**
 * Offizielle FIFA-Zuordnung der acht besten Gruppendritten zu den
 * Sechzehntelfinal-Spielen der WM 2026 (Annex C der Turnierordnung, 495
 * Kombinationen). Abgeglichen mit Wikipedia "2026 FIFA World Cup knockout
 * stage" (Combinations of matches in the round of 32).
 *
 * Schluessel: die acht Gruppen (A-L), deren Dritte sich qualifizieren,
 *            alphabetisch sortiert (z.B. 'ABCDEFGH').
 * Wert:      Spielnummer => Gruppenbuchstabe, dessen Dritter in diesem
 *            Sechzehntelfinale spielt. Die acht Spiele mit einem
 *            Drittplatzierten sind 74,77,79,80,81,82,85,87.
 *
 * Die Spaltenzuordnung wurde gegen die Kandidatenlisten der Quelle geprueft
 * (z.B. Spiel 74 = 3A/B/C/D/F): die Vereinigung der je Spalte moeglichen
 * Gruppen stimmt eindeutig mit der jeweiligen Quelle-Liste ueberein.
 */
return [
